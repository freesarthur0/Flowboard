...
Object.assign(window, {
  openModal, closeModal, saveCard, editCard, deleteCard,
  modalDuplicateCard, modalDeleteCard, modalCreateReminder,
  renderTagPills, removeTag, handleTagKey,
  renderAssigneePills, removeAssignee, handleAssigneeKey,
  renderChecklistEditor, handleChecklistKey, addCheckItem, removeCheckItem,
  addDep, removeDep
});
