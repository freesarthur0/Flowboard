...
Object.assign(window, {
  requestNotifPermission, playAlarm, toggleSidebarRemForm, toggleRemForm,
  saveReminder, toggleReminder, deleteReminder, renderReminders,
  dismissNotif, doneFromNotif
});
